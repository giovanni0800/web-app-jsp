...
$('body').append('' +
    '<div class="fixed-button">' +
        '<a href="https://github.com/giovanni0800?tab=repositories" target="_blank" class="btn btn-md btn-secondary">' +
            '<i class="fa-brands fa-github fa-fw" aria-hidden="true"></i> See more projects' +
        '</a> ' +
    '</div>' +
'');
var $window = $(window);
