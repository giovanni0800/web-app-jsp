...
<nav class="navbar header-navbar pcoded-header">
	              <div class="navbar-wrapper">
	                  <div class="navbar-logo">
	                      ...
	                      <a href="<%=request.getContextPath() %>/major-screen/major.jsp">
	                          <img width="80px" class="img-fluid" src="<%= request.getContextPath()%>/assets/images/JavaLogo.jpg" alt="Theme-Logo" />
	                      </a>
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <span class="special-font"><%= request.getSession().getAttribute("user") %></span>
