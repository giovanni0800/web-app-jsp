...
import org.apache.tomcat.jakartaee.commons.compress.utils.*;
...
public class ServletUserController extends HttpServlet {
	...
	// IF SOME PROBLEM OCURRE, DELETE THIS
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action != null && !action.isEmpty() && action.equalsIgnoreCase("exclude")) {
			...
			response.addHeader("totalPages",
					"" + daoUser.consultUserByNameToShowInPaginationModal(userName, userIdInSession));
